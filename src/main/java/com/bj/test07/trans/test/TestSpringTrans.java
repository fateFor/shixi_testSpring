package com.bj.test07.trans.test;

import com.bj.test07.trans.dao.IBookShopDao;
import com.bj.test07.trans.exception.AccountException;
import com.bj.test07.trans.exception.BookStockException;
import com.bj.test07.trans.service.IBookShopService;
import com.bj.test07.trans.service.ICashierService;
...
public class TestSpringTrans {
    ...
    {
        ac = new ClassPathXmlApplicationContext("beans_test07_trans.xml");
